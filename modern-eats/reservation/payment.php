...
<body>
    ...
    <script>
        ...
        window.onload = function () {
            ...
            const pay = document.getElementById('payment-total');
            pay.textContent = `Price: ₹${cost}`;
            const payItems = document.getElementById('payment-items');
            const selectedTables = <?php echo json_encode($tables); ?>;
            payItems.textContent = "You have selected table no.: " + selectedTables.join(", ");
        };
            ...
            const interval = setInterval(() => {
                ...
                if (progress === 10) {
                    ...
                    setTimeout(() => {
                        ...
                        window.location.href = 'http://localhost/modern-eats/reservation/confirmation.php';
                    }, 2000);
                }
            }, 300);
        });
